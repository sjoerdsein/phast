 ...
 */
/*****************************************************************************/
/* $Id: tdclifetm.h,v 1.4 2021/02/03 13:40:15 trurl Exp $ */
 ...
 *
 *  @note The function implicitly enables the timer tick channel 104
 *  (see @ref TDC_enableMarkers)  because the timing information is
 ...
 *  This may be the start input or one of the stop input channels.
 *  The function implicitly clears the histograms.
 *  @param startChan    Channel for start events,
 *                      Range: 0 (for start) and 1...32, default = 0
 *  @return             Error code
 */
 ...
 *  vice versa.
 *  @param stopCh       Channel for stop events, Range = 1...32
