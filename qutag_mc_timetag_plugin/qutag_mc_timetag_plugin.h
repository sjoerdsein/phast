...
#ifndef QUTAG_MC_TIMETAG_PLUGIN_H
#define QUTAG_MC_TIMETAG_PLUGIN_H

#include "qutag_mc_timetag_plugin_global.h"
...
class QUTAG_MC_TIMETAG_PLUGINSHARED_EXPORT Qutag_mc_timetag_plugin : public QObject,
                                                               public ITimetagPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "qutag_mc_itimetagplugin" )
    Q_INTERFACES(ITimetagPlugin)

private:
    qutag_mc_communicator* comm;
...
public:
    Qutag_mc_timetag_plugin();
    virtual ~Qutag_mc_timetag_plugin();
...
#endif // QUTAG_MC_TIMETAG_PLUGIN_H
