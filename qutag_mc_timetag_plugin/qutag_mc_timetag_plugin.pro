...
TARGET = qutag_mc_timetag_plugin
TEMPLATE = lib
CONFIG += plugin

DEFINES += QUTAG_MC_TIMETAG_PLUGIN_LIBRARY
...
LIBS += -L$$PWD/qutag_mc_lib -ltdcbase
...
SOURCES += \
        qutag_mc_timetag_plugin.cpp \
    qutag_mc_communicator.cpp \
    triggersettings_ui.cpp

HEADERS += \
        qutag_mc_timetag_plugin.h \
        qutag_mc_timetag_plugin_global.h \ 
    qutag_mc_communicator.h \
